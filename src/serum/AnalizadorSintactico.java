 ...
 * @version Sun Jun 17 01:33:06 CEST 2018
 */
public class AnalizadorSintactico extends java_cup.runtime.lr_parser {
    ...
    public static void main(String[] args){
        try {
            ...
            result.identifiers(new IdTable());
            result.typeCheck();
            int i = 0;
            java.util.List<serum.codegen.PInstruction> code = result.toCode();
            for (serum.codegen.PInstruction pinstruction : code)
                pinstruction.setPosition(i++);
            for (serum.codegen.PInstruction pinstruction : code)
                System.out.print(pinstruction.toString());
        } catch (Exception ex) {
            ex.printStackTrace();
        }
    }
            ...
            throws java.lang.Exception
    {
        ...
        switch (CUP$AnalizadorSintactico$act_num)
        {
            ...
            case 18: // type ::= type LBRACKET INTEGER_LITERAL RBRACKET
            {
                ...
                RESULT = Type.array(t, new Integer(numberOfElements));
